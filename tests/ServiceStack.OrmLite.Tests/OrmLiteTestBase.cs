...
namespace ServiceStack.OrmLite.Tests
{
    public class Config
    {
        ...
        public static string PostgreSqlDb = "Server=localhost;Port=5432;IntegratedSecurity=true;Database=OrmLiteUnitTests;Pooling=true;MinPoolSize=0;MaxPoolSize=200"; // "Server=localhost;Port=5432;User Id=test;Password=test;Database=test;Pooling=true;MinPoolSize=0;MaxPoolSize=200";
